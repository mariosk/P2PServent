...
File "${SRC_DIR}\images\mysearch.gif"
File "${SRC_DIR}\images\mysettings.gif"
File "${SRC_DIR}\images\myshared.gif"
...
Delete "$INSTDIR\images\mydownloads.gif"
Delete "$INSTDIR\images\myfriends.gif"
Delete "$INSTDIR\images\mypeers.gif"
Delete "$INSTDIR\images\mysearch.gif"
Delete "$INSTDIR\images\mysettings.gif"
