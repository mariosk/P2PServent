 ...
 */
public class STSearchResultsDataModel implements STISearchDataModel
{
    /**
     ...
     */
    private STSearchTreeTableModel visualizationModel;
    ...
    private STSearchResultsDataModel( Search search, SearchFilterRules filterRules )
    {
        this.search = search;
        ...
        Runnable runnable = new Runnable()
        {
            public void run()
            {
                ...
                visualizationModel.fireTreeStructureChanged( 
                    STSearchResultsDataModel.this, path, null, null );
            }
        };
...
//        }
    ...
    public static STSearchResultsDataModel registerNewSearch( Search search,
        SearchFilterRules filterRules )
    {
        STSearchResultsDataModel dataModel = new STSearchResultsDataModel( search, filterRules );
        searchToDataModelMap.put( search, dataModel );
        return dataModel;
    }
    
    public static STSearchResultsDataModel lookupResultDataModel( Search search )
    {
    ...
    {
        STSearchResultsDataModel dataModel = searchToDataModelMap.remove( search );
        if ( dataModel != null )
        {
            dataModel.release();
        }
