 ...
 *
 */
public class STSearchTreeTableModel extends AbstractTreeTableModel
...
//            Localizer.getString( "SHA1" )
    ...
    private STISearchDataModel displayedDataModel;
    ...
    public STSearchTreeTableModel()
    {
        super( TREE_ROOT, COLUMN_IDS, tableColumns, tableClasses );
        sortedColumn = -1;
    }

    public void setDisplayedSearch( STISearchDataModel dataModel )
    {
     ...
     * @return
     */
    public STISearchDataModel getDisplayedResultsData()
    {
